...
EXAMPLE usage:
partial / html:
<div jrg-datetimepicker ng-model='ngModel' validate='validateDate' onchange='onchangeDate' opts='opts'></div>
	...
	*/
	...
	return {
		...
		compile: function(element, attrs) {
			...
			var skipAttrs =['jrgDatetimepicker', 'ngModel', 'label', 'type', 'placeholder', 'opts', 'name', 'validate', 'onchange', 'ngClick'];
